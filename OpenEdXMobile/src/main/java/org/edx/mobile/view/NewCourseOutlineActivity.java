 ...
 */
public class NewCourseOutlineActivity extends CourseVideoListActivity {

    private NewCourseOutlineFragment fragment;
    ...
    protected void onLoadData() {
        ...
        if (fragment == null) {
            fragment = new NewCourseOutlineFragment();
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            fragment = (NewCourseOutlineFragment)
                    getSupportFragmentManager().findFragmentByTag(NewCourseOutlineFragment.TAG);
        }
    }
